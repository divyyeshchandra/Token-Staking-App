...
SELECT_CONTRACT[_NETWORK_ID] = {
  ...
  STACKING: {
    sevenDays: {
      //Old contract address 0x1230e2850538A2147b52F5DA11c445fe3ff3427c
      address: "0x2EB1B9cCa5460028F66f6CcCCCaF78F486a7D837",
    },
    tenDays: {
    ...
    abi: [
      ...
      {
        inputs: [],
        name: "getEarlyUnstakeFeePercantage",
        outputs: [
          {
            internalType: "uint256",
            name: "",
  ...
  TOKEN: {
    symbol: "DBC",
    address: "0x189429D9FA0331452eafC7D931536c4CE7e05f03",
    abi: [
      {
        inputs: [],
        stateMutability: "nonpayable",
